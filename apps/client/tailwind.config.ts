...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "primary": "0 10px 30px -15px hsl(var(--shadow-primary))",
        "lg": "0 10px 25px -5px hsl(var(--shadow-lg))",
        "glow": "0 0 20px hsl(var(--glow-primary))",
      },
      animation: {
        "fade-in": "fade-in var(--transition-medium) ease-out",
        "fade-out": "fade-out var(--transition-medium) ease-out",
        "slide-in": "slide-in var(--transition-medium) ease-out",
        "scale-in": "scale-in var(--transition-fast) ease-out",
        "bounce-in": "bounce-in var(--transition-bounce) ease-out",
